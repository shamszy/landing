<template>
    ...
    <footer class="mx-auto mt-40 max-w-7xl overflow-hidden px-6 pb-20 sm:mt-64 sm:pb-24 lg:px-8">
        ...
        <p class="mt-10 text-center text-xs leading-5 text-gray-500">&copy; 2023 MIREMCO. All rights reserved.</p>
    </footer>
</template>
...
const footerNavigation = {
    ...
    social: [
        {
            name: 'Facebook',
            href: 'https://web.facebook.com/SoundCoreGroup',
        ...
        {
            name: 'Instagram',
            href: 'https://www.instagram.com/soundcoregroup/',
            icon: defineComponent({
                render: () =>
                    h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
                        h('path', {
        ...
        {
            name: 'X',
            href: 'https://twitter.com/SoundCoreGroup',
            icon: defineComponent({
                render: () =>
